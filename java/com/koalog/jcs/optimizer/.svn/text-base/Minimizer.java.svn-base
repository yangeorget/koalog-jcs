...
/**
 * This class implements a minimizer.
 * @author Yan Georget
 */
public class Minimizer extends BacktrackOptimizer { 
    //------------------------------------------------------------------------
    // CONSTRUCTORS
    //------------------------------------------------------------------------  
    /**
     ...
     * of the search tree
     */
    public Minimizer(IntegerVariable variable,
    ...
    public IntegerDomain optimizingDomain() {
        return new MinMaxDomain(IntegerDomain.DEFAULT_MIN,
                                optimum-1);
    }
}
/*
