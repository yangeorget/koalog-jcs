 ...
 * @author Yan Georget
 */
public class Atmost extends AbstractCheck {
    //------------------------------------------------------------------------
    // CONSTRUCTORS
    //------------------------------------------------------------------------
    /**
     ...
     * @param c an integer
     */    
    public Atmost(int p, IntegerVariable[] variables, int c) {
        super(p, variables, c);
        name = "atmost(" + p + ", x, " + c + ")";
    }
    ...
    public void filter(ChoicePointStack cp,
        ...
        vars.clear();
        nbEqual = p; // max number of
        nbDifferent = variables.length-p; // min number of
