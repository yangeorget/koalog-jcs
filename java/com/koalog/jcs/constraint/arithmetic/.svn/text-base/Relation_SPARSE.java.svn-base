 ...
 * @author Yan Georget
 */
public class Relation_SPARSE extends BaseProblem {
    //------------------------------------------------------------------------
    // CONSTRUCTORS
    //------------------------------------------------------------------------
    /**
     ...
     */
    public Relation_SPARSE(IntegerVariable[] variables, int[][] values) {
        super("relation");
        ...
        for(int i=0; i<variables.length; i++) {
            ...
            add(new Element_SPARSE(variables[i], index, vals));
        }
     ...
     * @since 3.1
     */
    public Relation_SPARSE(IntegerVariable[] variables, List values) {
