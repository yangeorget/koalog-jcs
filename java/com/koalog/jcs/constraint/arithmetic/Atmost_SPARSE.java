...
/**
 * This constraint enforces that at most p variables 
 ...
 * @author Yan Georget
 */
public class Atmost_SPARSE extends Atmost {
    //------------------------------------------------------------------------
    // CONSTRUCTORS
    //------------------------------------------------------------------------
    /**
     ...
     * @param c an integer
     */    
    public Atmost_SPARSE(int p, IntegerVariable[] variables, int c) {
        super(p, variables, c);
    }
...
/*
 * $Log$
 * Revision 1.17  2005/07/18 15:32:55  yan
 * implememented 0021253: exceptions hierarchy
 *
 * Revision 1.16  2004/11/26 16:54:50  yan
 * optimized
 *
 ...
 * fixed complexity
 *
 * Revision 1.13  2004/06/15 13:26:45  yan
 * various optimizations and refactoring
 *
 * Revision 1.12  2004/06/10 14:38:08  yan
 * various refactoring
 *
 * Revision 1.11  2004/05/05 11:46:48  yan
 * fixed style
 *
 * Revision 1.10  2004/04/13 15:32:43  yan
 * adjustDifferent can only be used for variables with a sparse domain
 *
 * Revision 1.9  2003/10/02 23:49:00  yan
 ...
 *
 * Revision 1.5  2003/03/20 19:17:03  yan
 * added entailment statement
 *
 * Revision 1.4  2003/03/07 11:19:02  yan
 * fixed style
 *
 * Revision 1.3  2003/02/25 11:22:18  yan
 * changed conditions for InvalidConstraint
 *
 * Revision 1.2  2003/02/11 10:26:41  yan
 * fixed style
 *
 * Revision 1.1  2003/02/10 11:01:27  yan
 * initial revision
 *
 */
