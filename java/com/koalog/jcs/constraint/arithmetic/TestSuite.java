...
/**
 * Runs all the tests of the arithmetic package.
...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public TestSuite(String name) {
        super(name);
        addTestSuite(AbsTest.class);
        addTestSuite(AllDifferentTest.class);
        addTestSuite(AllDifferentSumTest.class);
        addTestSuite(AtleastTest.class);
        addTestSuite(AtmostTest.class);
        addTestSuite(ConstantSumTest.class);
        addTestSuite(CountTest.class);
        addTestSuite(CycleTest.class);
        addTestSuite(ElementTest.class);
        addTestSuite(EqTest.class);
        addTestSuite(ExactlyTest.class);
        addTestSuite(GCCTest.class);
        addTestSuite(ConstantWeightedSumTest.class);
        addTestSuite(IncreasingTest.class);
        addTestSuite(LeqShiftTest.class);
        addTestSuite(LeqTest.class);
        addTestSuite(LessTest.class);
        addTestSuite(LexLeqTest.class);
        addTestSuite(MaxTest.class);
        addTestSuite(MulTest.class);
        addTestSuite(NeqTest.class);
        addTestSuite(PermutationTest.class);
        addTestSuite(ProdTest.class);
        addTestSuite(InDomainTest.class);
        addTestSuite(RelationTest.class);
        addTestSuite(ShiftTest.class);
        addTestSuite(SortTest.class);
        addTestSuite(WeightedSumTest.class);
    }
    ...
    public static Test suite() {
        return new TestSuite("arithmetic");
    }
}
