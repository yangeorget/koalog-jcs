...
public class ConjunctionTest extends TestCase {
    ...
    public void testConjunction() {
        ...
        p.add(new Conjunction(a, new BooleanVariable[] {b, c}));
    ...
    // STATIC PROPERTIES
    //------------------------------------------------------------------------
    private static Category cat = Category.getInstance(Conjunction.class);
}
/*
 * $Log$
