...
/**
 * This constraint enforces x=(if b then c else y), 
 ...
 * @author Yan Georget
 */
public class IfThenElse_3 extends TernaryConstraint {
    //------------------------------------------------------------------------
    // PROPERTIES
    //------------------------------------------------------------------------
    private int c;
     ...
     */
    public IfThenElse_3(IntegerVariable x, 
                        BooleanVariable b, 
                        int c, 
                        IntegerVariable y) {
        super(x, b, y);
...
/*
 * $Log$
 * Revision 1.20  2005/07/25 09:48:21  yan
 * fixed 0021281
 *
 ...
 * moved
 *
 * Revision 1.3  2002/04/23 10:46:42  yan
 * fixed bug
 *
 * Revision 1.2  2002/04/22 14:06:46  yan
 * optimization (disjunctive construction)
 *
