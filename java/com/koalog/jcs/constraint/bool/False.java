 ...
 * @author Yan Georget
 */
public class False extends UnaryConstraint {
    //------------------------------------------------------------------------
    // CONSTRUCTORS
    //------------------------------------------------------------------------
    /**
     ...
     */
    public False(IntegerVariable x) {
        super(x);
        name = "x=0";
        idempotent = true;
        complexity = 1;
    ...
    public void init(ChoicePointStack cp,
        ...
        ((IntegerVariable) variables[0]).adjustValue(cp, cs, this, 0); 
