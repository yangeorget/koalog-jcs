...
/**
 * This constraint enforces: x is the union of y and z.
 *
 ...
 * @author Yan Georget
 */
public class Union extends TernaryConstraint {
    //------------------------------------------------------------------------
    // STATIC PROPERTIES
    //------------------------------------------------------------------------
    private static Category cat = Category.getInstance(Union.class);
     ...
     */
    public Union(SetVariable x, SetVariable y, SetVariable z) {
        super(x, y, z);
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public void filter(ChoicePointStack cp,
        ...
        xMin.addAll(z.getMin());
        final SortedSet xMax = new TreeSet(y.getMax());
        xMax.addAll(z.getMax());
        x.adjustMinMax(cp, cs, this, xMin, xMax);
        y.adjustMax(cp, cs, this, x.getMax());
        z.adjustMax(cp, cs, this, x.getMax());
    }
}
/*
 * $Log$
 ...
 * added @since tag
 *
 * Revision 1.6  2004/05/05 11:44:13  yan
 * fixed style
 *
