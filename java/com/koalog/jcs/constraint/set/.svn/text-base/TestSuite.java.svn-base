...
/**
 * Runs all the tests of the set package.
...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public TestSuite(String name) {
        super(name);
        addTestSuite(CardTest.class);    
        addTestSuite(EqTest.class);
        addTestSuite(EmptyIntersectionTest.class);
        addTestSuite(IntersectionTest.class);
        addTestSuite(IntersectsTest.class);
        addTestSuite(LeqTest.class);
        addTestSuite(MinTest.class);
        addTestSuite(MaxTest.class);
        addTestSuite(UnionTest.class);
    }
