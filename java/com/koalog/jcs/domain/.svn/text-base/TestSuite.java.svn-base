...
/**
 * Runs all the tests of the domain package.
...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public TestSuite(String name) {
        super(name);
        addTestSuite(MinMaxDomainTest.class);
        addTestSuite(SetDomainTest.class);
        addTestSuite(SparseDomainTest.class);
    }
    ...
    public static Test suite() {
        return new TestSuite("domain");
    }
}
/*
 * $Log$
 * Revision 1.6  2004/05/05 14:00:16  yan
 * fixed style
 *
 * Revision 1.5  2003/06/17 17:05:11  yan
 * added test for set domain
 *
