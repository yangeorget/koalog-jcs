...
/**
 * Runs all the tests of the choicepoint package.
...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public TestSuite(String name) {
        super(name);
        addTestSuite(ChoicePointStackTest.class);
        addTestSuite(StorableIntReferenceTest.class);
    }
    ...
    public static Test suite() {
        return new TestSuite("choicepoint");
    }
}
/*
 * $Log$
 * Revision 1.2  2004/06/15 14:07:02  yan
 * added test for StorableIntReference
 *
